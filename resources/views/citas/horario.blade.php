                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <h5 class="card-title font-weight-bold">Horas disponible</h5>
                            ...
                            <a class="btn btn-danger" href="{{ route('citas.medicos', $especialidad->id) }}" role="button"><svg viewBox="0 0 20 20" fill="currentColor" class="arrow-left w-6 h-6"><path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd"></path></svg>Volver</a>
